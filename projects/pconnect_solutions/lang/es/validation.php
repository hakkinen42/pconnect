...
|--------------------------------------------------------------------------
|
| Aquí puede especificar mensajes de validación personalizados para atributos utilizando la convención "attribute.rule" para nombrar las líneas. Esto hace que sea rápido especificar una línea de idioma personalizada específica para una regla de atributo determinada.
|
*/
...
| con algo más amigable para el lector, como "Dirección de Correo Electrónico"
| en lugar de "correo electrónico". Esto simplemente nos ayuda a hacer nuestro mensaje
| más expresivo.
|
*/
