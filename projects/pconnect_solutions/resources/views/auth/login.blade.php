    ...
    <div class="container px-4 py-5">
        ...
        <form class="forms-sample" id="loginForm" action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" id="email" placeholder="{{__('messages.login.mail')}}" value="{{ old('email') }}">
                @error('email')
            ...
            <div>
                <button id="btnLogin" type="submit" class="btn btn-primary text-white me-2 mb-2 mb-md-0" id="btnRegister">{{ __('messages.buton.login') }}</button>
